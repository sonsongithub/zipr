    ...
    class var pagingCommands: [UIKeyCommand] {
        ...
        return [
            UIKeyCommand(title: "Page Left",
                image: nil,
                action: #selector(BaseViewController.pageLeft(_:)),
            ...
            UIKeyCommand(title: "Page Right",
                image: nil,
                action: #selector(BaseViewController.pageRight(_:)),
            ...
            UIKeyCommand(title: "Shift Page Left",
                image: nil,
                action: #selector(BaseViewController.shiftPageLeft(_:)),
                input: UIKeyCommand.inputLeftArrow,
            ...
            UIKeyCommand(title: "Shift Page Right",
                image: nil,
                action: #selector(BaseViewController.shiftPageRight(_:)),
                input: UIKeyCommand.inputRightArrow,
                modifierFlags: [.alternate],
                propertyList: nil,
                alternates: [],
            ...
            UIKeyCommand(title: "Page Forward",
                image: nil,
                action: #selector(BaseViewController.pageForward(_:)),
